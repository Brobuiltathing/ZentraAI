...
QFrame#chat_area, QWidget#chat_area {
    background-color: #141418;
    border: none;
}
...
QWidget#message_user {
    background-color: #1e1e28;
    border-radius: 2px;
    border-left: 3px solid #e4a853;
    padding: 14px 20px;
    margin: 6px 80px 6px 140px;
}
...
QTextEdit#input_box {
    ...
    font-family: "JetBrains Mono", "Cascadia Code", "Consolas", monospace;
    padding: 14px 18px;
    selection-background-color: #e4a853;
