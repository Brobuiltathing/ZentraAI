...
from PySide6.QtWidgets import (
    ...
    QPushButton, QScrollArea, QSpacerItem, QSizePolicy, QFrame,
)
...
class SettingsPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        clear_mem_btn = QPushButton("Clear Conversation Memory")
        clear_mem_btn.setObjectName("danger_btn")
        clear_mem_btn.clicked.connect(self._clear_memory)
        layout.addWidget(clear_mem_btn)

        clear_emails_btn = QPushButton("Clear Seen Emails Cache")
        clear_emails_btn.setObjectName("danger_btn")
        clear_emails_btn.clicked.connect(self._clear_emails)
    ...
    def _save(self):
        ...
        try:
            config.MEMORY_DEPTH = int(self.input_depth.text().strip())
        except ValueError:
            pass

        try:
            config.RUN_TIMEOUT_SECONDS = int(self.input_timeout.text().strip())
        except ValueError:
            pass
