...
from config import PSUTIL_AVAILABLE, PYAUTOGUI_AVAILABLE
from logger import log
from ollama import ollama_raw_sync, ollama_vision_sync

if PSUTIL_AVAILABLE:
    import psutil

if PYAUTOGUI_AVAILABLE:
    from actions.screen import _take_screenshot_sync
